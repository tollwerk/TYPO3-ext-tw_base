...
// SELECT CONCAT(`lg_name_local`, " (", lg_name_en, ")") AS label, IF(lg_collate_locale = "", LOWER(lg_iso_2), lg_collate_locale) AS iso FROM `static_languages` ORDER BY lg_name_en ASC
$languages = [
